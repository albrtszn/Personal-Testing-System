...
namespace Client.classDTO
{
    public class Rating
    {
        ...
        public static int GetPointTest(AnswersUserTest ans, string idTest)
        {
            int res = 0;
            int kol_Q = 0;
            int kol_A = 0;
            ...
            switch (idTest)
            {
                ...
                case test_tehno:
                    ...
                    for (int i = 0; i < kol_Q; i++)
                    {
                        ...
                        for (int j = 0; j < kol_A; j++)
                        {
                            ...
                            if ((ans.Questions[i].Answers[j].Correct == ans.Questions[i].Answers[j].IsUserAnswer) && (ans.Questions[i].Answers[j].Correct == true)) 
                            {
                                res = res + ans.Questions[i].Answers[j].Weight;
                                break;
                            }
                ...
                case test_loyalty:
                    ...
                    for (int i = 0; i < kol_Q; i++)
                    {
                        tmp_num = numbers.Contains(ans.Questions[i].Number);
                        if (tmp_num == false)
                        {
                            continue;
                        }
                        ...
                        for (int j = 0; j < kol_A; j++)
                        {
                            if ((ans.Questions[i].Answers[j].IsUserAnswer == true))
                            {
                                res = res + ans.Questions[i].Answers[j].Weight;
                                break;
                            }
                ...
                case test_moral:
                    ...
                    for (int i = 0; i < kol_Q; i++)
                    {
                        tmp_num = numbers1_da.Contains(ans.Questions[i].Number);
                        if (tmp_num == true)
                        {
                            if (ans.Questions[i].Answers[0].IsUserAnswer == true)
                            {
                                res1 = res1 + 1;
                            }
                        }

                        tmp_num = numbers1_no.Contains(ans.Questions[i].Number);
                        if (tmp_num == true)
                        {
                            if (ans.Questions[i].Answers[1].IsUserAnswer == true)
                            {
                                res1 = res1 + 1;
                            }
                        }

                        tmp_num = numbers2_no.Contains(ans.Questions[i].Number);
                        if (tmp_num == true)
                        {
                            if (ans.Questions[i].Answers[1].IsUserAnswer == true)
                            {
                        ...
                        tmp_num = numbers3_no.Contains(ans.Questions[i].Number);
                        if (tmp_num == true)
                        {
                            if (ans.Questions[i].Answers[1].IsUserAnswer == true)
                            {
                        ...
                        tmp_num = numbers4_no.Contains(ans.Questions[i].Number);
                        if (tmp_num == true)
                        {
                            if (ans.Questions[i].Answers[1].IsUserAnswer == true)
                            {
                        ...
                        tmp_num = numbers5_no.Contains(ans.Questions[i].Number);
                        if (tmp_num == true)
                        {
                            if (ans.Questions[i].Answers[1].IsUserAnswer == true)
                            {
                        ...
                        tmp_num = numbers6_da.Contains(ans.Questions[i].Number);
                        if (tmp_num == true)
                        {
                            if (ans.Questions[i].Answers[0].IsUserAnswer == true)
                            {
